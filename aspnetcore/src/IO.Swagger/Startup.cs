            ...
            services
                .AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("1.0.0-oas3", new Info
                    {
                        ...
                        Description = "UTM DSS/USS API (ASP.NET Core 2.0)",
                        Contact = new Contact()
                        {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            app
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/swagger/1.0.0-oas3/swagger.json", "UTM DSS/USS API");

                    //TODO: Or alternatively use the original Swagger contract that's included in the static files
                    // c.SwaggerEndpoint("/swagger-original.json", "UTM DSS/USS API Original");
                });
