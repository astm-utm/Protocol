...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class GetOperationReferenceResponse : IEquatable<GetOperationReferenceResponse>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetOperationReferenceResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((GetOperationReferenceResponse)obj);
        }

        /// <summary>
        /// Returns true if GetOperationReferenceResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of GetOperationReferenceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetOperationReferenceResponse other)
        {
            ...
            return 
                (
                    ...
                    OperationReference.Equals(other.OperationReference)
                );
        }
        ...
        public static bool operator ==(GetOperationReferenceResponse left, GetOperationReferenceResponse right)
        {
